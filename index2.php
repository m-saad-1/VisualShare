...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        /* Typography & Buttons */
        h1, h2, h3, h4, h5, h6 { font-family: var(--font-heading); font-weight: 700; margin-bottom: 1rem; color: var(--primary-color); }
        h1 { font-size: 2.5rem; }
        h2 { font-size: 2rem; }
        .btn { display: inline-block; padding: 10px 20px; border-radius: 4px; font-weight: 500; text-align: center; cursor: pointer; transition: var(--transition); border: 1px solid transparent; }
        .btn-primary { background-color: var(--secondary-color); color: var(--white); }
        .btn-primary:hover { background-color: #c49555; }
        ...
        /* Section Title */
        .section-title { text-align: center; font-size: 2.5rem; margin-bottom: 60px; position: relative; color: #333; }
        .section-title::after { content: ''; display: block; width: 80px; height: 4px; background: linear-gradient(to right, var(--secondary-color), #c49555); margin: 15px auto 0; }

        /* Featured Categories */
        .featured-categories { padding: 80px 0; background: white; }
        .category-grid { display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 30px; }
        .category-card { position: relative; border-radius: 10px; overflow: hidden; box-shadow: 0 15px 30px rgba(0,0,0,0.1); height: 350px; }
        .category-card img { width: 100%; height: 100%; object-fit: cover; transition: transform 0.5s ease; }
        .category-card:hover img { transform: scale(1.05); }
        .category-card h3 { position: absolute; bottom: 0; left: 0; width: 100%; padding: 20px; margin: 0; color: white; background: linear-gradient(to top, rgba(0,0,0,0.8) 0%, transparent 100%); }

        /* Original Featured Products Section Styles */
        .featured-products { padding: 80px 0; background-color: var(--bg-light); }
        .featured-products .product-grid { display: grid; grid-template-columns: repeat(4, 1fr); gap: 30px; }
        .product-card { background-color: var(--white); border-radius: 8px; overflow: hidden; box-shadow: 0 3px 10px rgba(0, 0, 0, 0.05); transition: var(--transition); position: relative; display: flex; flex-direction: column; height: 100%; }
        .product-card:hover { box-shadow: 0 5px 15px rgba(0, 0, 0, 0.1); transform: translateY(-5px); }
        .product-badge { position: absolute; top: 10px; left: 10px; background-color: var(--accent-color); color: var(--white); padding: 3px 10px; border-radius: 4px; font-size: 0.8rem; font-weight: 500; z-index: 2; }
        .product-badge.new { background-color: var(--success-color); }
        .product-image { position: relative; overflow: hidden; height: 250px; flex-shrink: 0; }
        .product-image img { width: 100%; height: 100%; object-fit: cover; transition: var(--transition); }
        .product-card:hover .product-image img { transform: scale(1.05); }
        .product-info { padding: 20px; flex-grow: 1; display: flex; flex-direction: column; }
        .product-title { font-size: 1rem; margin-bottom: 10px; color: var(--primary-color); line-height: 1.4; min-height: 42px; }
        .product-price { display: flex; align-items: center; gap: 10px; margin: 10px 0; flex-wrap: wrap; }
        .current-price { font-weight: 700; font-size: 1.1rem; color: var(--secondary-color); }
        .old-price { text-decoration: line-through; color: var(--light-text); font-size: 0.9rem; }
        .discount { background-color: var(--accent-color); color: var(--white); font-size: 0.8rem; padding: 2px 8px; border-radius: 4px; margin-left: auto; }
        .product-meta { margin-top: auto; display: flex; align-items: center; gap: 10px; font-size: 0.9rem; color: var(--light-text); }
        .rating { display: flex; align-items: center; gap: 5px; }
        .stars { color: var(--secondary-color); }
        .product-actions { position: absolute; bottom: -50px; left: 0; right: 0; background-color: var(--white); padding: 15px; display: flex; justify-content: center; gap: 10px; opacity: 0; transition: var(--transition); z-index: 2; }
        .product-card:hover .product-actions { bottom: 0; opacity: 1; }
        .action-btn { width: 40px; height: 40px; border-radius: 50%; background-color: var(--secondary-color); color: var(--white); display: flex; align-items: center; justify-content: center; border: none; cursor: pointer; transition: var(--transition); box-shadow: 0 2px 5px rgba(0,0,0,0.1); }
        .action-btn:hover { background-color: var(--primary-color); transform: translateY(-2px); box-shadow: 0 4px 8px rgba(0,0,0,0.15); }
        ...
        /* Original Testimonials Section Styles */
        .testimonials { padding: 100px 0; background: white; text-align: center; }
        .testimonial-slider { max-width: 1000px; margin: 0 auto; display: flex; overflow-x: auto; scroll-snap-type: x mandatory; scroll-behavior: smooth; -webkit-overflow-scrolling: touch; padding-bottom: 40px; }
        .testimonial-slide { scroll-snap-align: start; flex-shrink: 0; width: 100%; background: white; padding: 50px; border-radius: 10px; box-shadow: 0 10px 30px rgba(0,0,0,0.05); margin: 0 20px; position: relative; text-align: center; }
        .testimonial-slide::before { content: '"'; position: absolute; top: 20px; left: 20px; font-size: 5rem; color: rgba(212, 167, 98, 0.1); font-family: serif; line-height: 1; }
        .testimonial-content { font-size: 1.2rem; line-height: 1.8; margin-bottom: 25px; color: #555; position: relative; z-index: 2; font-style: italic; }
        .testimonial-author { font-weight: 700; color: #333; margin-bottom: 5px; font-size: 1.1rem; }
        .testimonial-role { color: #999; font-size: 0.9rem; }
        .testimonial-rating { color: var(--secondary-color); margin-bottom: 15px; font-size: 1.2rem; }
        ...
        @media (max-width: 1024px) {
            ...
            .featured-products .product-grid { grid-template-columns: repeat(3, 1fr); }
        }
        @media (max-width: 768px) {
            .hero h1 { font-size: 3rem; }
            .promo-content-new h2 { font-size: 2.2rem; }
            .featured-products .product-grid { grid-template-columns: repeat(2, 1fr); }
        }
    ...
    <section class="featured-categories">
        <div class="container">
            ...
            <div class="category-grid">
                <a href="shop.php?category=shirts" class="category-card"> <img src="https://images.unsplash.com/photo-1598033129183-c4f50c736f10?auto=format&fit=crop&w=1025&q=80" alt="Shirts"> <h3>Shirts</h3> </a>
                <a href="shop.php?category=jeans" class="category-card"> <img src="https://images.unsplash.com/photo-1541099649105-f69ad21f3246?auto=format&fit=crop&w=987&q=80" alt="Jeans"> <h3>Jeans</h3> </a>
                <a href="shop.php?category=jackets" class="category-card"> <img src="https://images.unsplash.com/photo-1551028719-00167b16eac5?auto=format&fit=crop&w=1035&q=80" alt="Jackets"> <h3>Jackets</h3> </a>
                <a href="shop.php?category=accessories" class="category-card"> <img src="https://images.unsplash.com/photo-1590874103328-eac38a683ce7?auto=format&fit=crop&w=1038&q=80" alt="Accessories"> <h3>Accessories</h3> </a>
            </div>
        </div>
    </section>

    <!-- Featured Products Section (Reverted) -->
            ...
            <div class="product-grid">
                ...
                <div class="product-card" data-id="3">
                    ...
                    <div class="product-info">
                        ...
                        <div class="product-price"><span class="current-price">$99.99</span></div>
                        <div class="product-meta">
                            <div class="rating">
                                <div class="stars">
                ...
                <div class="product-card" data-id="4">
                    ...
                    <div class="product-info">
                        ...
                        <div class="product-price"><span class="current-price">$69.99</span></div>
                        <div class="product-meta">
                            <div class="rating">
                                <div class="stars">
                                    <i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="far fa-star"></i>
        ...
        <div class="container">
            ...
            <div class="testimonial-slider">
                <div class="testimonial-slide">
                    ...
                    <div class="testimonial-content"><p>"I absolutely love the quality of the clothes from FashionHub. The fit is perfect and the materials are so comfortable. I'll definitely be shopping here again!"</p></div>
                    <div class="testimonial-author">Sarah Johnson</div>
                    <div class="testimonial-role">Happy Customer</div>
                </div>
                <div class="testimonial-slide">
                    <div class="testimonial-rating"><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i></div>
                    <div class="testimonial-content"><p>"The shipping was incredibly fast and the customer service was excellent. Highly recommend FashionHub for all your fashion needs!"</p></div>
                ...
                <div class="testimonial-slide">
                    ...
                    <div class="testimonial-content"><p>"I've purchased multiple items and each one has exceeded my expectations. The quality is outstanding and the prices are very reasonable."</p></div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function goToHeroSlide(slideNumber) {
        ...
        currentHeroSlide = (slideNumber + heroSlides.length) % heroSlides.length;
